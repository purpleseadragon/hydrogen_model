...
file_path = r"C:\Users\o_dav\Dropbox\2023_thesis\wind_data.xlsx"

df = pd.read_excel(file_path, sheet_name='ref')
...
def plot_average_energy_per_day(df):
    sum_by_time_of_day = df.groupby('local_time')['Power Outout (KW)'].sum()
